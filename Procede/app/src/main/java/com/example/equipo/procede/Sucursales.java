 ...
 * {@link Sucursales.OnFragmentInteractionListener} interface
...
public class Sucursales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton a =  view.findViewById(R.id.floatingActionButton5);
        a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent apq =  new Intent(getActivity(),addSucursales.class);
